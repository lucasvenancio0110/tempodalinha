...
# Replace final preset renderer with edit/read-only variants and show in editor immediately.
...
# Ensure editor includes preset immediately below result preview.
...
if needle in text:
    ...
    # fallback insert before closing section in final editor renderer
    marker = '          </div>\n        </section>`;'
...
# Ensure result/dashboard uses read-only preset renderer.
